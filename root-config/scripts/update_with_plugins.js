...
fs.writeFile(paths.pkgJsonBackupPath, JSON.stringify(originalPackageJson, null, 2), 'utf8', (err) => {
  if (err) throw err;
  console.log(`Adding Foreman plugins to package.json, the original package.json is backed up at ${paths.pkgJsonBackupPath}. The modified package.json will be reverted back to 
